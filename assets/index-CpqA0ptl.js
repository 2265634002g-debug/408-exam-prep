...
- [[2011-大题44] [2015-大题44] [2018-大题44]]`},{id:`co-5-1-1`,chapterId:`co-5`,title:`CPU的功能与基本结构`,keyConcepts:[`CPU`,`运算器`,`控制器`,`PC`,`IR`,`MAR`,`MDR`,`寄存器`],relatedPoints:[`co-2-4-1`,`co-4-1-1`],content:`## CPU 的两大组成部分
...
- 前V后P：前操作之后V，后操作之前P`},{id:`os-5-1-1`,chapterId:`os-5`,title:`I/O管理概述`,keyConcepts:[`I/O`,`设备独立性`,`逻辑设备`,`物理设备`,`SPOOLing`],relatedPoints:[`os-5-2-1`],content:`## I/O 设备分类
