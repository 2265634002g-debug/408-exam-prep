...
- 片选信号由**高位地址**经译码器产生
- [[2015-选择15] [2023-选择15]]`}],_r=[{id:`os-1-1-1`,chapterId:`os-1`,title:`操作系统的概念与特征`,keyConcepts:[`操作系统`,`并发`,`共享`,`虚拟`,`异步`,`基本特征`],relatedPoints:[`os-1-3-1`],content:`## 操作系统的定义
...
- [[2023-选择31]]`}],vr=[{id:`cn-1-1-1`,chapterId:`cn-1`,title:`计算机网络概述`,keyConcepts:[`计算机网络`,`组成`,`功能`,`分类`,`LAN`,`WAN`,`MAN`],relatedPoints:[],content:`## 计算机网络的定义
...
- 总时延 ≠ 简单的单段时延 × 段数
- 时延带宽积 = "管道"中的比特数
- [[2013-选择35] [2023-选择33]]`}],yr=[{id:`ma-1-1-1`,chapterId:`ma-1`,title:`函数的概念、性质与初等函数`,keyConcepts:[`函数`,`定义域`,`值域`,`单调性`,`奇偶性`,`周期性`,`有界性`,`初等函数`],relatedPoints:[],content:`## 函数的定义
