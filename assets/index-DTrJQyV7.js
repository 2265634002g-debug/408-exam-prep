...
- 互斥微命令=不能在同一微指令中同时有效的命令`},{id:`co-5-4-1`,chapterId:`co-5`,title:`异常与中断`,keyConcepts:[`异常`,`中断`,`内中断`,`外中断`,`中断向量`,`中断响应`,`中断返回`],relatedPoints:[`co-7-3-1`,`os-1-3-1`],content:`## 异常 vs 中断
