...
- 增加物理内存是解决抖动的**最根本方法**
- 工作集窗口 $\\Delta$ 的选取很关键——太大=过时，太小=不准确`},{id:`os-4-1-1`,chapterId:`os-4`,title:`文件系统基础`,keyConcepts:[`文件`,`目录`,`FCB`,`inode`,`文件控制块`,`目录结构`],relatedPoints:[],content:`## 文件的逻辑结构
