...
- Load-Use冒险需要转发**+停顿**
- 2024年真题考了此知识点 (Q19)
- [[2024-选择19]]`}],_r=[{id:`os-1-1-1`,chapterId:`os-1`,title:`操作系统的概念与特征`,keyConcepts:[`操作系统`,`并发`,`共享`,`虚拟`,`异步`,`基本特征`],relatedPoints:[`os-1-3-1`],content:`## 操作系统的定义
...
- GET 是幂等的（重复请求不影响），POST 不是`}],yr=[{id:`ma-1-1-1`,chapterId:`ma-1`,title:`函数的概念、性质与初等函数`,keyConcepts:[`函数`,`定义域`,`值域`,`单调性`,`奇偶性`,`周期性`,`有界性`,`初等函数`],relatedPoints:[],content:`## 函数的定义
