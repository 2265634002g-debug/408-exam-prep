...
- 磁盘控制器 = I/O接口（芯片/电路）
- 408常考区分"设备"和"接口"
- [[2021-选择20]]`}],_r=[{id:`os-1-1-1`,chapterId:`os-1`,title:`操作系统的概念与特征`,keyConcepts:[`操作系统`,`并发`,`共享`,`虚拟`,`异步`,`基本特征`],relatedPoints:[`os-1-3-1`],content:`## 操作系统的定义
