...
- 总芯片数 = 位扩展数 × 字扩展数
- [[2009-选择15]]`}],_r=[{id:`os-1-1-1`,chapterId:`os-1`,title:`操作系统的概念与特征`,keyConcepts:[`操作系统`,`并发`,`共享`,`虚拟`,`异步`,`基本特征`],relatedPoints:[`os-1-3-1`],content:`## 操作系统的定义
...
- 删除硬链接 ≠ 删除数据（计数>1时）
- 软链接类似Windows的"快捷方式"
- [[2009-选择31]]`}],vr=[{id:`cn-1-1-1`,chapterId:`cn-1`,title:`计算机网络概述`,keyConcepts:[`计算机网络`,`组成`,`功能`,`分类`,`LAN`,`WAN`,`MAN`],relatedPoints:[],content:`## 计算机网络的定义
