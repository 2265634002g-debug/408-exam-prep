...
`},{id:`co-3-4-2`,chapterId:`co-3`,title:`虚实地址转换全流程 (TLB+页表+Cache)`,keyConcepts:[`TLB`,`页表`,`Cache`,`虚实地址`,`缺页`,`访存次数`],relatedPoints:[`co-3-4-1`,`co-3-3-1`,`co-3-3-2`],content:`## 完整地址转换流程
\`\`\`
CPU给出虚拟地址VA
  -> 查TLB(快表)
    命中? -> 得页框号 -> 物理地址PA
