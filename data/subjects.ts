    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'os-2-3', title: '同步与互斥', knowledgePointIds: ['os-2-3-1'] },
    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'cn-3-2', title: '组帧', knowledgePointIds: [] },
          ...
          { id: 'cn-3-7', title: '广域网', knowledgePointIds: [] },
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'cn-4-3', title: 'IPv6', knowledgePointIds: [] },
          { id: 'cn-4-4', title: '路由算法与路由协议', knowledgePointIds: ['cn-4-4-1'] },
          { id: 'cn-4-5', title: 'IP 多播', knowledgePointIds: [] },
          { id: 'cn-4-6', title: '移动 IP', knowledgePointIds: [] },
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'cn-6-3', title: 'FTP', knowledgePointIds: [] },
