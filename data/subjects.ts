    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'co-3-5', title: '外部存储器', knowledgePointIds: ['co-3-5-1'] },
        ],
      },
      {
        id: 'co-4',
    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          { id: 'ma-2-3', title: '微分中值定理', knowledgePointIds: ['ma-2-3-1'] },
          { id: 'ma-2-4', title: '洛必达法则', knowledgePointIds: ['ma-2-4-1'] },
          { id: 'ma-2-5', title: '泰勒公式', knowledgePointIds: ['ma-2-5-1'] },
          { id: 'ma-2-6', title: '函数的单调性与极值', knowledgePointIds: ['ma-2-6-1'] },
          { id: 'ma-2-7', title: '函数的凹凸性与拐点', knowledgePointIds: ['ma-2-7-1'] },
          { id: 'ma-2-8', title: '曲率与曲率半径', knowledgePointIds: ['ma-2-8-1'] },
        ],
      },
      {
        id: 'ma-3', chapterNum: 3, title: '一元函数积分学',
        sections: [
          { id: 'ma-3-1', title: '不定积分的概念与性质', knowledgePointIds: ['ma-3-1-1'] },
          { id: 'ma-3-2', title: '不定积分的计算（换元与分部）', knowledgePointIds: ['ma-3-2-1'] },
          { id: 'ma-3-3', title: '定积分的概念与性质', knowledgePointIds: ['ma-3-3-1'] },
          { id: 'ma-3-4', title: '定积分的计算（牛顿-莱布尼茨）', knowledgePointIds: ['ma-3-4-1'] },
          { id: 'ma-3-5', title: '广义积分', knowledgePointIds: ['ma-3-5-1'] },
          { id: 'ma-3-6', title: '定积分的应用（面积与体积）', knowledgePointIds: ['ma-3-6-1'] },
        ],
      },
      {
        id: 'ma-4', chapterNum: 4, title: '多元函数微分学',
        sections: [
          { id: 'ma-4-1', title: '多元函数的基本概念', knowledgePointIds: ['ma-4-1-1'] },
          { id: 'ma-4-2', title: '偏导数与全微分', knowledgePointIds: ['ma-4-2-1'] },
          { id: 'ma-4-3', title: '多元复合函数求导', knowledgePointIds: ['ma-4-3-1'] },
          { id: 'ma-4-4', title: '隐函数求导', knowledgePointIds: ['ma-4-4-1'] },
          { id: 'ma-4-5', title: '多元函数的极值与条件极值', knowledgePointIds: ['ma-4-5-1'] },
        ],
      },
      {
        id: 'ma-5', chapterNum: 5, title: '多元函数积分学',
        sections: [
          { id: 'ma-5-1', title: '二重积分的概念与计算', knowledgePointIds: ['ma-5-1-1'] },
          { id: 'ma-5-2', title: '三重积分', knowledgePointIds: ['ma-5-2-1'] },
          { id: 'ma-5-3', title: '曲线积分', knowledgePointIds: ['ma-5-3-1'] },
          { id: 'ma-5-4', title: '曲面积分', knowledgePointIds: ['ma-5-4-1'] },
          { id: 'ma-5-5', title: '格林公式与高斯公式', knowledgePointIds: ['ma-5-5-1'] },
        ],
      },
      {
        ...
        sections: [
          ...
          { id: 'ma-6-2', title: '一阶微分方程', knowledgePointIds: ['ma-6-2-1'] },
          { id: 'ma-6-3', title: '高阶常系数线性微分方程', knowledgePointIds: ['ma-6-3-1'] },
          { id: 'ma-6-4', title: '欧拉方程', knowledgePointIds: ['ma-6-4-1'] },
        ],
      },
      {
        id: 'ma-7', chapterNum: 7, title: '无穷级数',
        sections: [
          { id: 'ma-7-1', title: '常数项级数的概念与性质', knowledgePointIds: ['ma-7-1-1'] },
          { id: 'ma-7-2', title: '正项级数的审敛法', knowledgePointIds: ['ma-7-2-1'] },
          { id: 'ma-7-3', title: '幂级数', knowledgePointIds: ['ma-7-3-1'] },
          { id: 'ma-7-4', title: '傅里叶级数', knowledgePointIds: ['ma-7-4-1'] },
        ],
      },
      {
        ...
        sections: [
          ...
          { id: 'ma-8-5', title: '二次型', knowledgePointIds: ['ma-8-5-1'] },
        ],
      },
      {
        ...
        sections: [
          ...
          { id: 'ma-9-3', title: '多维随机变量', knowledgePointIds: ['ma-9-3-1'] },
          { id: 'ma-9-4', title: '数字特征（期望/方差/协方差）', knowledgePointIds: ['ma-9-4-1'] },
          { id: 'ma-9-5', title: '大数定律与中心极限定理', knowledgePointIds: ['ma-9-5-1'] },
          { id: 'ma-9-6', title: '数理统计（估计与检验）', knowledgePointIds: ['ma-9-6-1'] },
          { id: 'ma-9-7', title: '常用统计分布', knowledgePointIds: ['ma-9-7-1'] },
        ],
      },
    ],
  },
